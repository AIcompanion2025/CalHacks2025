...
*This PRD template was automatically generated when creating your lunar-beaver-bloom app. Please customize it based on your specific requirements using the Deep Mode PRD flow in SnapDev.*
